...
public class CatalogActivity extends AppCompatActivity {
    ...
    private void displayDatabaseInfo() {
        ...
        try {
            ...
            int genderCoumnIndex = cursor.getColumnIndex(PetEntry.COLUMN_PET_GENDER);
            ...
            while (cursor.moveToNext()){
                ...
                int currenGender = cursor.getInt(genderCoumnIndex);
                int currentWeight = cursor.getInt(weightColumnIndex);

                //Display the values from each colum of the current row in the cursor
                //in the TextView: text_view_pet
                displayView.append(("\n" + currentID + " - " +
                        currentName + " - " +
                        currentBreed + " - " +
                        currenGender + " - " +
